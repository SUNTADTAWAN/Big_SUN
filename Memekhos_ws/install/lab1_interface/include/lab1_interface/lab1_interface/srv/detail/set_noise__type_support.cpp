...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SetNoise_Request_message_member_array[3] = {
  {
    "mean",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(lab1_interface::srv::SetNoise_Request, scale),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
