...
#include "controller_interface/srv/detail/set_param__rosidl_typesupport_fastrtps_c.h"
...
using _SetParam_Request__ros_msg_type = controller_interface__srv__SetParam_Request;
...
size_t get_serialized_size_controller_interface__srv__SetParam_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetParam_Request__ros_msg_type * ros_message = static_cast<const _SetParam_Request__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _SetParam_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_controller_interface__srv__SetParam_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_controller_interface
size_t max_serialized_size_controller_interface__srv__SetParam_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = controller_interface__srv__SetParam_Request;
    is_plain =
      (
...
static size_t _SetParam_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_controller_interface__srv__SetParam_Request(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, controller_interface, srv, SetParam_Request)() {
...
using _SetParam_Response__ros_msg_type = controller_interface__srv__SetParam_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_controller_interface
size_t get_serialized_size_controller_interface__srv__SetParam_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetParam_Response__ros_msg_type * ros_message = static_cast<const _SetParam_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_controller_interface__srv__SetParam_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_controller_interface
size_t max_serialized_size_controller_interface__srv__SetParam_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = controller_interface__srv__SetParam_Response;
    is_plain =
      (
...
static size_t _SetParam_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_controller_interface__srv__SetParam_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, controller_interface, srv, SetParam_Response)() {
...
// already included above
// #include "controller_interface/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "controller_interface/srv/set_param.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, controller_interface, srv, SetParam)() {
