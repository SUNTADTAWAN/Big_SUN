...
#ifndef CONTROLLER_INTERFACE__SRV__DETAIL__SET_PARAM__FUNCTIONS_H_
#define CONTROLLER_INTERFACE__SRV__DETAIL__SET_PARAM__FUNCTIONS_H_
 ...
 * calls
 * controller_interface__srv__SetParam_Request__init().
...
/**
 * It calls
 * controller_interface__srv__SetParam_Request__fini()
 ...
 * controller_interface__srv__SetParam_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * controller_interface__srv__SetParam_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * controller_interface__srv__SetParam_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_controller_interface
...
/**
 * It calls
 * controller_interface__srv__SetParam_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_controller_interface
...
/**
 * It allocates the memory for the array and calls
 * controller_interface__srv__SetParam_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_controller_interface
...
/**
 * It calls
 * controller_interface__srv__SetParam_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // CONTROLLER_INTERFACE__SRV__DETAIL__SET_PARAM__FUNCTIONS_H_
