...
class Metaclass_SetParam(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'controller_interface.srv.SetParam')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from controller_interface.srv import _set_param
...
class SetParam(metaclass=Metaclass_SetParam):
    from controller_interface.srv._set_param import SetParam_Request as Request
    from controller_interface.srv._set_param import SetParam_Response as Response
