...
#include "controller_interface/srv/detail/set_param__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const controller_interface::srv::SetParam_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  controller_interface::srv::SetParam_Request & ros_message)
{
  // Member: kp_linear
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = controller_interface::srv::SetParam_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const controller_interface::srv::SetParam_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<controller_interface::srv::SetParam_Request *>(
    untyped_ros_message);
...
{
  return &controller_interface::srv::typesupport_fastrtps_cpp::_SetParam_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, controller_interface, srv, SetParam_Request)() {
  return &controller_interface::srv::typesupport_fastrtps_cpp::_SetParam_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_controller_interface
cdr_serialize(
  const controller_interface::srv::SetParam_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  controller_interface::srv::SetParam_Response & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = controller_interface::srv::SetParam_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const controller_interface::srv::SetParam_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<controller_interface::srv::SetParam_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &controller_interface::srv::typesupport_fastrtps_cpp::_SetParam_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, controller_interface, srv, SetParam_Response)() {
  return &controller_interface::srv::typesupport_fastrtps_cpp::_SetParam_Response__handle;
}
...
{
  return &controller_interface::srv::typesupport_fastrtps_cpp::_SetParam__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, controller_interface, srv, SetParam)() {
  return &controller_interface::srv::typesupport_fastrtps_cpp::_SetParam__handle;
}
